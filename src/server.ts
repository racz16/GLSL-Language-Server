...
import { initializeConfiguration, isConfigurationSupported } from './core/configuration-manager';
...
export abstract class Server {
    ...
    private onInitialize(): void {
        this.connection.onInitialize((params: InitializeParams): InitializeResult => {
            initializeConfiguration(!!params.capabilities.workspace?.configuration);
            return {
                capabilities: {
